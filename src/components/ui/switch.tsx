...
>(({ className, ...props }, ref) => (
  <SwitchPrimitives.Root
    className={cn(
      ...
      "data-[state=checked]:bg-green-600 data-[state=checked]:border-green-500 data-[state=checked]:shadow-[0_0_8px_rgba(34,197,94,0.4)]",
  ...
  >
    <SwitchPrimitives.Thumb
      className={cn(
        ...
        "data-[state=unchecked]:translate-x-0.5 data-[state=unchecked]:bg-gray-400"
      )}
    />
  </SwitchPrimitives.Root>
))
