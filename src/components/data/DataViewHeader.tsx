...
export const DataViewHeader = () => {
  ...
  return (
    <nav className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-6 sticky top-0 bg-[#1A1F2C] w-full backdrop-blur-lg z-10 p-4 rounded-lg shadow-sm">
